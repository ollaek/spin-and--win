...
class Number extends React.Component{
    ...
    validateMobileNumber = () => {
        ...
        if ((phoneno.test(this.state.msisdn))) {
            ...
            this.setState({ msisdn : "" ,valid : false, ErrorMsg : "Wrong mobile number, please enter the right number"});
        }
        console.log(this.state);
    };
                ...
                <div>
                    <div id="wrapper">
                        <div className="dial-pad">
                                ...
                                <div>
                                    <div className="shadow" id="output"></div>
...
const mapStateToProps = state => {
    return { configuration : state.SpinAndWin.GET_CONFIGURATIONS };
}
